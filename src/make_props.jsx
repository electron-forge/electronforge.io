...
module.exports = [
  ...
  },
  {
    ...
    description: [
      ...
      <p>Please note that the information in this config object MUST match your application identity on the <a href="https://docs.microsoft.com/en-us/windows/uwp/publish/view-app-identity-details">Windows Store</a></p>,
      <p>You can find the complete documention for all options you can pass to electron-windows-store on the <a href="https://github.com/felixrieseberg/electron-windows-store#programmatic-usage">Electron Windows Store Repository</a></p>,
    ],
  },
  {
    ...
    description: [
      ...
      <p>You can find the complete documention for all options you can pass to electron-installer-dmg on the <a href="https://github.com/mongodb-js/electron-installer-dmg#api">Electron Installer DMG Repository</a></p>,
    ],
  },
  {
    ...
    description: [
      ...
      <p>You can find the complete documention for all options you can pass to electron-installer-debian on the <a href="https://github.com/unindented/electron-installer-debian#options">Electron Installer Debian Repository</a></p>,
    ],
  },
  {
    ...
    description: [
      ...
      <p>You can find the complete documention for all options you can pass to electron-installer-redhat on the <a href="https://github.com/unindented/electron-installer-redhat#options">Electron Installer Redhat Repository</a></p>,
    ],
  },
  {
    ...
    description: [
      ...
      <p>You can find the complete documention for all options you can pass to electron-installer-flatpak on the <a href="https://github.com/endlessm/electron-installer-flatpak#options">Electron Installer Flatpak Repository</a></p>,
    ],
  },
];
