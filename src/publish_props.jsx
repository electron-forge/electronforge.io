...
module.exports = [
  {
    ...
    description: [
      ...
      <p>You can find a <Link to="/config/extra/possible-publish-targets">list of publish targets</Link> in our documentation.</p>,
    ],
  },
  {
    ...
    properties: [
      {
        name: 'accessKey',
        type: 'String',
        description: 'Your access key for your AWS account (falls back to the standard AWS_ACCESS_KEY_ID environment variable).',
      },
      {
        name: 'bucket',
        type: 'String',
      ...
      },
      {
        name: 'folder',
        type: 'String',
        description: 'The folder path to upload to inside your bucket, defaults to your application version.',
      },
      {
        name: 'public',
        type: 'Boolean',
        description: 'Whether to make the S3 upload public, defaults to "false".',
      },
    ],
  },
];
