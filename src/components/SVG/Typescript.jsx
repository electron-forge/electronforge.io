...
export default class TypescriptSVG extends PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 630 630" width={`${width}px`} height={`${height}px`} >
        <g transform="translate(0.000000,630.000000) scale(0.100000,-0.100000)" fill="#007ACC" stroke="none">
